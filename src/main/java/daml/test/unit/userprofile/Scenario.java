package daml.test.unit.userprofile;
...
public final class Scenario extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("f0dcbf884b6b6c6225689dfc29d021f7054d825e7f59acb15e7d4ca03ecb808d", "Test.Unit.UserProfile", "Scenario");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, Scenario> COMPANION = 
      new ContractCompanion.WithoutKey<>("daml.test.unit.userprofile.Scenario", TEMPLATE_ID,
  ...
  public String toString() {
    return String.format("daml.test.unit.userprofile.Scenario(%s)", this.parties);
  }
