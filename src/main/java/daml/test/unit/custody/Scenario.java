package daml.test.unit.custody;
...
public final class Scenario extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("8b6e58552ef878dbcd4586daf541e0ca6dd1b0d75795e7f9ece68259cb3242b1", "Test.Unit.Custody", "Scenario");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, Scenario> COMPANION = 
      new ContractCompanion.WithoutKey<>("daml.test.unit.custody.Scenario", TEMPLATE_ID,
        ContractId::new, v -> Scenario.templateValueDecoder().decode(v), Scenario::fromJson,
        Contract::new, List.of(CHOICE_Setup, CHOICE_Archive));
  ...
  public String toString() {
    return String.format("daml.test.unit.custody.Scenario(%s)", this.parties);
  }
