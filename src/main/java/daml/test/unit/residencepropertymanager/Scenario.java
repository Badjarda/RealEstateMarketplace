...
public final class Scenario extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("63d617a230e28827582264ee3744a561fc8af088ff34f73d66177b7ef8e26382", "Test.Unit.ResidencePropertyManager", "Scenario");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, Scenario> COMPANION = 
      new ContractCompanion.WithoutKey<>("daml.test.unit.residencepropertymanager.Scenario",
  ...
  public String toString() {
    return String.format("daml.test.unit.residencepropertymanager.Scenario(%s)", this.parties);
  }
