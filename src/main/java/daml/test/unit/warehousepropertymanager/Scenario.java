package daml.test.unit.warehousepropertymanager;
...
public final class Scenario extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("b93cea58d2cd7e7792117719e7c79bd5a10ca2a87dc57a03f202a3ec5bc6c5d9", "Test.Unit.WarehousePropertyManager", "Scenario");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, Scenario> COMPANION = 
      new ContractCompanion.WithoutKey<>("daml.test.unit.warehousepropertymanager.Scenario",
        TEMPLATE_ID, ContractId::new, v -> Scenario.templateValueDecoder().decode(v),
        Scenario::fromJson, Contract::new, List.of(CHOICE_Archive, CHOICE_Setup));
  ...
  public String toString() {
    return String.format("daml.test.unit.warehousepropertymanager.Scenario(%s)", this.parties);
  }
