package daml.test.unit.garagepropertymanager;
...
public final class Scenario extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("0d9ec89bad8d531192667801b2000705bd418a72539b23331a355e1e2c1609a4", "Test.Unit.GaragePropertyManager", "Scenario");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, Scenario> COMPANION = 
      new ContractCompanion.WithoutKey<>("daml.test.unit.garagepropertymanager.Scenario",
  ...
  public String toString() {
    return String.format("daml.test.unit.garagepropertymanager.Scenario(%s)", this.parties);
  }
