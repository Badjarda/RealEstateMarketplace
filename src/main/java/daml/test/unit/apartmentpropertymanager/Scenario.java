package daml.test.unit.apartmentpropertymanager;
...
public final class Scenario extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("8b6e58552ef878dbcd4586daf541e0ca6dd1b0d75795e7f9ece68259cb3242b1", "Test.Unit.ApartmentPropertyManager", "Scenario");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, Scenario> COMPANION = 
      new ContractCompanion.WithoutKey<>("daml.test.unit.apartmentpropertymanager.Scenario",
  ...
  public String toString() {
    return String.format("daml.test.unit.apartmentpropertymanager.Scenario(%s)", this.parties);
  }
