package daml.test.unit.landpropertymanager;
...
public final class Scenario extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("63d617a230e28827582264ee3744a561fc8af088ff34f73d66177b7ef8e26382", "Test.Unit.LandPropertyManager", "Scenario");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, Scenario> COMPANION = 
      new ContractCompanion.WithoutKey<>("daml.test.unit.landpropertymanager.Scenario", TEMPLATE_ID,
        ContractId::new, v -> Scenario.templateValueDecoder().decode(v), Scenario::fromJson,
        Contract::new, List.of(CHOICE_Archive, CHOICE_Setup));
  ...
  public String toString() {
    return String.format("daml.test.unit.landpropertymanager.Scenario(%s)", this.parties);
  }
