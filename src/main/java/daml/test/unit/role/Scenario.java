...
public final class Scenario extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("f8883c36e16696951f0e9312ee45dacca92b05226daf215a5159b95d1b1c4079", "Test.Unit.Role", "Scenario");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, Scenario> COMPANION = 
      new ContractCompanion.WithoutKey<>("daml.test.unit.role.Scenario", TEMPLATE_ID,
  ...
  public String toString() {
    return String.format("daml.test.unit.role.Scenario(%s)", this.parties);
  }
