...
public final class RequestCreateUserProfile extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("63d617a230e28827582264ee3744a561fc8af088ff34f73d66177b7ef8e26382", "App.ProfileManager.Model", "RequestCreateUserProfile");
  ...
  public static JsonLfDecoder<RequestCreateUserProfile> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("operator", "user", "id", "username", "firstName", "lastName", "fullName", "birthday", "gender", "nationality", "contactMail", "cellphoneNumber", "taxId", "socialSecurityId", "observers"), name -> {
          switch (name) {
            ...
            case "gender": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(8, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.optional(daml.interface$.profilemanager.userprofile.common.Gender.jsonDecoder()));
            case "nationality": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(9, daml.interface$.profilemanager.userprofile.common.Nationality.jsonDecoder());
  ...
  public String toString() {
    return String.format("daml.app.profilemanager.model.RequestCreateUserProfile(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
