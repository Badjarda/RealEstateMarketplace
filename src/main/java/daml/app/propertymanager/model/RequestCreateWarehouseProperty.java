...
public final class RequestCreateWarehouseProperty extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("63d617a230e28827582264ee3744a561fc8af088ff34f73d66177b7ef8e26382", "App.PropertyManager.Model", "RequestCreateWarehouseProperty");
  ...
  public String toString() {
    return String.format("daml.app.propertymanager.model.RequestCreateWarehouseProperty(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
