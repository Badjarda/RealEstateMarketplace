...
public class RequestCreateUserProfile extends DamlRecord<RequestCreateUserProfile> {
  ...
  public static JsonLfDecoder<RequestCreateUserProfile> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("id", "username", "firstName", "lastName", "fullName", "birthday", "gender", "nationality", "contactMail", "cellphoneNumber", "taxId", "socialSecurityId", "observers"), name -> {
          switch (name) {
            ...
            case "gender": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(6, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.optional(daml.interface$.profilemanager.userprofile.common.Gender.jsonDecoder()));
            case "nationality": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(7, daml.interface$.profilemanager.userprofile.common.Nationality.jsonDecoder());
  ...
  public String toString() {
    return String.format("daml.interface$.profilemanager.service.RequestCreateUserProfile(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
