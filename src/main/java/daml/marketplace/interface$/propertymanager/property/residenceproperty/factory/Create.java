...
public class Create extends DamlRecord<Create> {
  ...
  public static JsonLfDecoder<Create> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("instrument", "propertyKey", "propertyAddress", "propertyPostalCode", "propertyDistrict", "propertyCounty", "grossArea", "usableArea", "bedrooms", "bathrooms", "floors", "residenceType", "backyard", "parking", "buildDate", "orientation", "installedEquipment", "additionalInformation", "description", "observers"), name -> {
          switch (name) {
            ...
            case "residenceType": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(11, daml.interface$.propertymanager.property.common.ResidenceType.jsonDecoder());
            ...
            case "parking": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(13, daml.interface$.propertymanager.property.common.Parking.jsonDecoder());
            ...
            case "orientation": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(15, daml.interface$.propertymanager.property.common.Orientation.jsonDecoder());
  ...
  public String toString() {
    return String.format("daml.interface$.propertymanager.property.residenceproperty.factory.Create(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
