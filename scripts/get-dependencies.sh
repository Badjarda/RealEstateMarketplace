...
get_dependency daml-finance-instrument-swap               Daml.Finance.Instrument.Swap              0.3.0
...
get_dependency daml-finance-interface-instrument-generic  Daml.Finance.Interface.Instrument.Generic 2.0.0
get_dependency daml-finance-interface-instrument-swap     Daml.Finance.Interface.Instrument.Swap    0.3.0
